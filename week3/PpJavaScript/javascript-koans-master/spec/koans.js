...
describe("the JavaScript language", function(){
  ...
  describe("has different types and operators that", function(){
    ...
    it("considers an empty string to be falsy", function(){
        expect("" == false).toBeTruthy("Truthy");// Truthy or Falsy
        expect("" === false).toBeFalsy("Falsy");// Truthy or Falsy
    });

    it("considers zero to be falsy", function(){
        expect(0 == false).toBeTruthy("Truthy");// Truthy or Falsy
    ...
    it("considers nulls to be falsy", function(){
        ...
        expect(result == false).toBeTruthy("Truthy");// Truthy or Falsy
        expect(null === false).toBeFalsy("Falsy");// Truthy or Falsy
        expect(null == false).toBeFalsy("Falsy");// Truthy or Falsy
    });
    ...
    it("can't compare arrays", function(){
        ...
        expect(a == b).toBeFalsy("Falsy");  // Truthy or Falsy
        expect(a === b).toBeFalsy("Falsy"); // Truthy or Falsy
